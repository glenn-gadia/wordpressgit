...
function construct_banner_background() {
	...
	$subtitle = get_theme_mod('banner_main_title', __('', 'construct-ex'));
	$subpera = get_theme_mod('banner_para', __('', 'construct-ex'));
	$button_text1 = get_theme_mod('banner_btn1_txt', __('', 'construct-ex'));
	$button_text2 = get_theme_mod('banner_btn2_txt', __('', 'construct-ex'));
